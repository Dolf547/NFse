...
//Class '\Nfsews\Providers\Procempa\V3\Response\PedidoGerarNfseResponse' not found
include('adapted_vendor/nfse/src/Providers/Procempa/V3/Response/PedidoGerarNfseResponse.php');
include('adapted_vendor/nfse/src/Providers/Procempa/V3/Response/PedidoCancelarNfseResponse.php');
/* include('adapted_vendor/nfse/src/Providers/Procempa/V3/Response.php'); */
include('adapted_vendor/nfse/src/Providers/Procempa/V3/Response/PedidoConsultarNfseRpsResponse.php');


use Nfsews\Providers\Procempa\V3\Response\PedidoGerarNfseResponse;
use Nfsews\Providers\Procempa\V3\Response\PedidoCancelarNfseResponse;
class Soap
{
    private $wsdl = null;
