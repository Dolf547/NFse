...
class RpsFragmentoSv
{
    ...
    public function RPSSubmissao($RPSSubmissao)
    {
        $this->RPSSubmissao = $RPSSubmissao;
    }
    ...
    public function setValorLiquidoNfse($valorLiquidoNfe)
    {
        $this->ValorLiquidoNfse = number_format($valorLiquidoNfe, 2, '.', '');;
    }
